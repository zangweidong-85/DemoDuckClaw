...
PJ_DEF(pj_status_t) pj_register_strerror(pj_status_t start, pj_status_t space, pj_error_callback f)
{
    unsigned i;
    ...
    for (i = 0; i < err_msg_hnd_cnt; ++i) {
        if (IN_RANGE(start, err_msg_hnd[i].begin, err_msg_hnd[i].end) ||
            ...
            if (err_msg_hnd[i].begin == start && err_msg_hnd[i].end == (start + space) &&
...
PJ_DEF(void) pj_perror(int log_level, const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
...
PJ_DEF(void) pj_perror_1(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
...
PJ_DEF(void) pj_perror_2(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
...
PJ_DEF(void) pj_perror_3(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
...
PJ_DEF(void) pj_perror_4(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
...
PJ_DEF(void) pj_perror_5(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
...
PJ_DEF(void) pj_perror_6(const char *sender, pj_status_t status, const char *title_fmt, ...)
{
    va_list marker;
    va_start(marker, title_fmt);
