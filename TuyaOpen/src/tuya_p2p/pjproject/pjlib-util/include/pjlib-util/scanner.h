 ...
 */
PJ_DECL(void)
pj_scan_init(pj_scanner *scanner, char *bufstart, pj_size_t buflen, unsigned options, pj_syn_err_func_ptr callback);
 ...
 *         no more characters.
 */
PJ_DECL(int) pj_scan_peek(pj_scanner *scanner, const pj_cis_t *spec, pj_str_t *out);
 ...
 */
PJ_DECL(int) pj_scan_peek_until(pj_scanner *scanner, const pj_cis_t *spec, pj_str_t *out);
 ...
 * @param out       String to store the result.
 */
PJ_DECL(void) pj_scan_get(pj_scanner *scanner, const pj_cis_t *spec, pj_str_t *out);
 ...
 * @param out       String to store the result.
 */
PJ_DECL(void) pj_scan_get_unescape(pj_scanner *scanner, const pj_cis_t *spec, pj_str_t *out);
 ...
 * @param out           String to store the result.
 */
PJ_DECL(void) pj_scan_get_quote(pj_scanner *scanner, int begin_quote, int end_quote, pj_str_t *out);
 ...
 */
PJ_DECL(void)
pj_scan_get_quotes(pj_scanner *scanner, const char *begin_quotes, const char *end_quotes, int qsize, pj_str_t *out);
 ...
 * @param out       String to store the result.
 */
PJ_DECL(void) pj_scan_get_until(pj_scanner *scanner, const pj_cis_t *spec, pj_str_t *out);
 ...
 * @param out           String to store the result.
 */
PJ_DECL(void) pj_scan_get_until_ch(pj_scanner *scanner, int until_char, pj_str_t *out);
 ...
 * @param out           String to store the result.
 */
PJ_DECL(void) pj_scan_get_until_chr(pj_scanner *scanner, const char *until_spec, pj_str_t *out);
 ...
 */
PJ_DECL(void) pj_scan_advance_n(pj_scanner *scanner, unsigned N, pj_bool_t skip);
 ...
 */
PJ_DECL(void) pj_scan_save_state(const pj_scanner *scanner, pj_scan_state *state);
