 ...
 * function.
 */
#define pj_pool_create(fc, nm, init, inc, cb) pj_pool_create_imp(__FILE__, __LINE__, fc, nm, init, inc, cb)
...
#define pj_pool_calloc(pool, cnt, elem) pj_pool_calloc_imp(__FILE__, __LINE__, pool, cnt, elem)

#define pj_pool_zalloc(pool, sz) pj_pool_zalloc_imp(__FILE__, __LINE__, pool, sz)
...
/* Create pool */
PJ_DECL(pj_pool_t *)
pj_pool_create_imp(const char *file, int line, void *factory, const char *name, pj_size_t initial_size,
...
PJ_DECL(void *) pj_pool_alloc_imp(const char *file, int line, pj_pool_t *pool, pj_size_t sz);

/* Allocate memory from the pool and zero the memory */
PJ_DECL(void *) pj_pool_calloc_imp(const char *file, int line, pj_pool_t *pool, unsigned cnt, unsigned elemsz);

/* Allocate memory from the pool and zero the memory */
PJ_DECL(void *) pj_pool_zalloc_imp(const char *file, int line, pj_pool_t *pool, pj_size_t sz);
