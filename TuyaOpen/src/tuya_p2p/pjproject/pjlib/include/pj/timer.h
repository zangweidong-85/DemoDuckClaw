 ...
 */
PJ_DECL(pj_status_t) pj_timer_heap_create(pj_pool_t *pool, pj_size_t count, pj_timer_heap_t **ht);
 ...
 */
PJ_DECL(void) pj_timer_heap_set_lock(pj_timer_heap_t *ht, pj_lock_t *lock, pj_bool_t auto_del);
 ...
 */
PJ_DECL(unsigned) pj_timer_heap_set_max_timed_out_per_poll(pj_timer_heap_t *ht, unsigned count);
...
pj_timer_entry_init(pj_timer_entry *entry, int id, void *user_data, pj_timer_heap_callback *cb);
 ...
 */
#if PJ_TIMER_DEBUG
#define pj_timer_heap_schedule(ht, e, d) pj_timer_heap_schedule_dbg(ht, e, d, __FILE__, __LINE__)

PJ_DECL(pj_status_t)
pj_timer_heap_schedule_dbg(pj_timer_heap_t *ht, pj_timer_entry *entry, const pj_time_val *delay, const char *src_file,
                           int src_line);
#else
PJ_DECL(pj_status_t) pj_timer_heap_schedule(pj_timer_heap_t *ht, pj_timer_entry *entry, const pj_time_val *delay);
 ...
 *                  cancelled.
 */
PJ_DECL(int) pj_timer_heap_cancel_if_active(pj_timer_heap_t *ht, pj_timer_entry *entry, int id_val);
 ...
 */
PJ_DECL(pj_status_t) pj_timer_heap_earliest_time(pj_timer_heap_t *ht, pj_time_val *timeval);
 ...
 */
PJ_DECL(unsigned) pj_timer_heap_poll(pj_timer_heap_t *ht, pj_time_val *next_delay);
