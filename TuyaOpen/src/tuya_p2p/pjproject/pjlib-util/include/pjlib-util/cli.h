 ...
 */
PJ_DECL(void) pj_cli_write_log(pj_cli_t *cli, int level, const char *buffer, int len);
 ...
 * @param len           Length of this message.
 */
PJ_DECL(void) pj_cli_sess_write_msg(pj_cli_sess *sess, const char *buffer, pj_size_t len);
