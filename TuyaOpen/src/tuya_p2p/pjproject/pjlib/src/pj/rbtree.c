...
static void delete_fixup(pj_rbtree *tree, pj_rbtree_node *node)
{
    ...
    while (node != tree->root && node->color == PJ_RBCOLOR_BLACK) {
        if (node->parent->left == node) {
            ...
            if (temp->left->color == PJ_RBCOLOR_BLACK && temp->right->color == PJ_RBCOLOR_BLACK) {
                temp->color = PJ_RBCOLOR_RED;
                node = node->parent;
            } else {
            ...
            if (temp->right->color == PJ_RBCOLOR_BLACK && temp->left->color == PJ_RBCOLOR_BLACK) {
                temp->color = PJ_RBCOLOR_RED;
                node = node->parent;
            } else {
...
PJ_DEF(pj_rbtree_node *) pj_rbtree_next(pj_rbtree *tree, register pj_rbtree_node *node)
{
    register pj_rbtree_node *null = tree->null;
...
PJ_DEF(pj_rbtree_node *) pj_rbtree_prev(pj_rbtree *tree, register pj_rbtree_node *node)
{
    register pj_rbtree_node *null = tree->null;
