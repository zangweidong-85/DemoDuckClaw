...
PJ_IDEF(pj_str_t *) pj_strdup(pj_pool_t *pool, pj_str_t *dst, const pj_str_t *src)
{
...
PJ_IDEF(pj_str_t *) pj_strdup_with_null(pj_pool_t *pool, pj_str_t *dst, const pj_str_t *src)
{
...
PJ_IDEF(pj_str_t *) pj_strdup2_with_null(pj_pool_t *pool, pj_str_t *dst, const char *src)
{
    dst->slen = src ? pj_ansi_strlen(src) : 0;
...
PJ_IDEF(pj_str_t *) pj_strncpy(pj_str_t *dst, const pj_str_t *src, pj_ssize_t max)
{
    pj_assert(src->slen >= 0);
    pj_assert(max >= 0);
...
PJ_IDEF(pj_str_t *) pj_strncpy_with_null(pj_str_t *dst, const pj_str_t *src, pj_ssize_t max)
{
    pj_assert(src->slen >= 0);
    pj_assert(max > 0);
...
PJ_IDEF(int) pj_strncmp(const pj_str_t *str1, const pj_str_t *str2, pj_size_t len)
{
...
PJ_IDEF(int) strnicmp_alnum(const char *str1, const char *str2, int len)
{
    if (len == 0)
        ...
        register const pj_uint32_t *p1 = (pj_uint32_t *)str1, *p2 = (pj_uint32_t *)str2;
...
PJ_IDEF(int) pj_stricmp_alnum(const pj_str_t *str1, const pj_str_t *str2)
{
    ...
    if (len != str2->slen) {
        ...
        register const pj_uint32_t *p1 = (pj_uint32_t *)str1->ptr, *p2 = (pj_uint32_t *)str2->ptr;
        while (len > 3 && (*p1 & 0x5F5F5F5F) == (*p2 & 0x5F5F5F5F))
            ++p1, ++p2, len -= 4;
...
PJ_IDEF(int) pj_strnicmp(const pj_str_t *str1, const pj_str_t *str2, pj_size_t len)
{
    pj_str_t copy1, copy2;
