...
static int _getopt_internal(int argc, char *const *argv, const char *shortopts, const struct pj_getopt_option *longopts,
...
int pj_getopt_long(int argc, char *const *argv, const char *options, const struct pj_getopt_option *long_options,
                   int *opt_index)
{
...
{
    return _getopt_internal(argc, argv, optstring, (const struct pj_getopt_option *)0, (int *)0, 0);
}
...
static int _getopt_internal(int argc, char *const *argv, const char *optstring, const struct pj_getopt_option *longopts,
                            int *longind, int long_only)
{
    pj_optarg = NULL;
...
#define NONOPTION_P (argv[pj_optind][0] != '-' || argv[pj_optind][1] == '\0')
    ...
    if (nextchar == NULL || *nextchar == '\0') {
        ...
        nextchar = (argv[pj_optind] + 1 + (longopts != NULL && argv[pj_optind][1] == '-'));
    }
    ...
    if (longopts != NULL && (argv[pj_optind][1] == '-' ||
        ...
        if (!long_only || argv[pj_optind][1] == '-' || my_index(optstring, *nextchar) == NULL) {
            nextchar = (char *)"";
            pj_optind++;
            pj_optopt = 0;
            return '?';
