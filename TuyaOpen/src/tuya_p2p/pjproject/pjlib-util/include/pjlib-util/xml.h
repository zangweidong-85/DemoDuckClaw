 ...
 */
PJ_DECL(int) pj_xml_print(const pj_xml_node *node, char *buf, pj_size_t len, pj_bool_t prolog);
 ...
 */
PJ_DECL(pj_xml_attr *) pj_xml_attr_new(pj_pool_t *pool, const pj_str_t *name, const pj_str_t *value);
 ...
 */
PJ_DECL(pj_xml_node *) pj_xml_find_node(const pj_xml_node *parent, const pj_str_t *name);
 ...
 * @return          XML node found or NULL.
 */
PJ_DECL(pj_xml_node *) pj_xml_find_next_node(const pj_xml_node *parent, const pj_xml_node *node, const pj_str_t *name);
 ...
 * @return          XML node found or NULL.
 */
PJ_DECL(pj_xml_node *) pj_xml_find_node_rec(const pj_xml_node *parent, const pj_str_t *name);
 ...
 */
PJ_DECL(pj_xml_attr *) pj_xml_find_attr(const pj_xml_node *node, const pj_str_t *name, const pj_str_t *value);
