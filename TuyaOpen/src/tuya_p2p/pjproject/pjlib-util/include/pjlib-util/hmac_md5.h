 ...
 */
PJ_DECL(void)
pj_hmac_md5(const pj_uint8_t *input, unsigned input_len, const pj_uint8_t *key, unsigned key_len,
 ...
 * @param key_len       Length of the authentication key.
 */
PJ_DECL(void) pj_hmac_md5_init(pj_hmac_md5_context *hctx, const pj_uint8_t *key, unsigned key_len);
 ...
 * @param input_len     Length of input stream in bytes.
 */
PJ_DECL(void) pj_hmac_md5_update(pj_hmac_md5_context *hctx, const pj_uint8_t *input, unsigned input_len);
 ...
 * @param digest        Buffer to be filled with HMAC MD5 digest.
 */
PJ_DECL(void) pj_hmac_md5_final(pj_hmac_md5_context *hctx, pj_uint8_t digest[16]);
