...
typedef struct pj_stun_tsx_cb {
     ...
     */
    void (*on_complete)(pj_stun_client_tsx *tsx, pj_status_t status, const pj_stun_msg *response,
 ...
 */
PJ_DECL(pj_status_t)
pj_stun_client_tsx_schedule_destroy(pj_stun_client_tsx *tsx, const pj_time_val *delay);
 ...
 *                      as returned by \a on_send_msg() callback.
 */
PJ_DECL(pj_status_t) pj_stun_client_tsx_retransmit(pj_stun_client_tsx *tsx, pj_bool_t mod_count);
