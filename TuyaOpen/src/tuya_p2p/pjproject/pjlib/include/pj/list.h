 ...
 */
PJ_IDECL(void) pj_list_insert_nodes_before(pj_list_type *lst, pj_list_type *nodes);
 ...
 * @param nodes     Nodes list.
 */
PJ_IDECL(void) pj_list_insert_nodes_after(pj_list_type *lst, pj_list_type *nodes);
 ...
 *         found in the list.
 */
PJ_IDECL(pj_list_type *) pj_list_find_node(pj_list_type *list, pj_list_type *node);
